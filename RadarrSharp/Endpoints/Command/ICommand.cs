...
namespace RadarrSharp.Endpoints.Command
{
    ...
    public interface ICommand
    {
        ...
        /// <returns>Data.Command</returns>
        Task<Data.Command> RefreshMovie([Optional] int movieId);
        ...
        /// <param name="movieId">Movie ID</param>
        /// <returns>Data.Command</returns>
        Task<Data.Command> RescanMovie([Optional] int movieId);
        ...
        /// <returns>Data.Command</returns>
        Task<Data.Command> MoviesSearch(int[] movieIds);
        ...
        /// <returns>Data.Command</returns>
        Task<Data.Command> RenameMovies(int[] movieIds);
        ...
        /// <returns>Data.Command</returns>
        Task<Data.Command> CutOffUnmetMoviesSearch(string filterKey, string filterValue);

        /// <summary>
        /// Instructs Radarr to search all lists for movies not yet added to Radarr.
        /// </summary>
        /// <returns>Data.Command</returns>
        Task<Data.Command> NetImportSync();
        ...
        /// <returns>Data.Command</returns>
        Task<Data.Command> MissingMoviesSearch(string filterKey, string filterValue);
    }
}
